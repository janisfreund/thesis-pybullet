...
class CameraStateSampler(ob.RealVectorStateSampler):
    ...
    def sampleGoodCameraPosition(self, state):
        ...
        if random_num < 0.5:
            ...
            l1 = p.addUserDebugLine(final_position, obj_pos, lineColorRGB=[1, 0, 0], lineWidth=5)
            l2 = p.addUserDebugLine(final_position, debug_point, lineColorRGB=[0, 0, 1], lineWidth=5)
            l3 = p.addUserDebugLine(position_cam, debug_target, lineColorRGB=[0, 1, 0], lineWidth=5)
